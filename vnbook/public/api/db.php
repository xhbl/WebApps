...
class DB {
    ...
    public static function vnb() { return self::con(C_VNB_DB_NAME); }
    
    /** Helper for Base Dictionary DB */
    public static function base() { return self::con(C_DB_BASE); }
}

/** Legacy support wrappers */
function vnb_dbconnect() { return DB::vnb(); }
function vnb_db_con() { return DB::vnb(); }
function vnb_dbselectadmin() { return DB::vnb() !== null; }
