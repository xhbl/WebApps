...
(function ($) {
    ...
    function maldpeConfigEvent() {
        ...
        // 选项展开或选中事件
        $("#maldpe-config .config-item .select").off('click').on('click', function(e) {
            e.stopPropagation();
        ...
        // 保存配置
        $('#maldpe-config button[type="submit"]').off('click').on('click', function() {
            foldConfigOption();
        ...
        // 重置配置
        $('#maldpe-config button[type="reset"]').off('click').on('click', function() {
    ...
    function termNumberClickEvent() {
        $(".sense > .sn_letter").off('click').on('click', function(e) {
            e.stopPropagation();
            $(this).siblings(".vis_w").slideToggle('fast');
        });

        $(".maldpe .sn_block_num, .maldpe h2.dre").off('click').on('click', function(e) {
            e.stopPropagation(); 
    ...
    function fnTouchToTranslate(itemValue) {
        ...
        // examples
        $(".maldpe ul.vis > li.vi").off('click').on('click', function(e) {
            e.stopPropagation();
       ...
       // 项义点击事件：显示和隐藏中文
        $(".maldpe span.def_text, .maldpe .both_text, .maldpe .syn_par_t").off('click').on('click', function(event) {
        ...
        // Usage用法释义
        $(".maldpe span.ud_text").off('click').on('click', function(e) {
            e.stopPropagation();
            $(this).find(".mw_zh").fadeToggle("fast");
        });

        // 固定搭配释义
        $(".maldpe span.un_text").off('click').on('click', function(e) {
            e.stopPropagation();
            $(this).find(".mw_zh").fadeToggle("fast");
        }); 
    }
    ...
    (async function initTTS() {
        ...
        maldpeCfg.enableOnlineTTS && $(".maldpe example-audio-ai a.audio_uk, .maldpe example-audio-ai a.audio_us").off('click').on('click', function(e) {
            e.stopPropagation();
            e.preventDefault();
