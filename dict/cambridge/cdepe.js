...
(function ($) {
    ...
    function fnImgClickEvent() {
        $(".cdepe .dimg").off('click').on('click', function(e) {
    ...
    function cdepeConfigEvent() {
        ...
        // 选项展开或选中事件
        $("#cdepe-config .config-item .select").off('click').on('click', function(e) {
            e.stopPropagation();
        ...
        // 保存配置
        $('#cdepe-config button[type="submit"]').off('click').on('click', function() {
            foldConfigOption();
        ...
        // 重置配置
        $('#cdepe-config button[type="reset"]').off('click').on('click', function() {
    ...
    function cdepeClickEvent() {
        // 义项按钮展开与折叠事件
        $(".cdepe .senseButton").off('click').on('click', function(e) {
            e.stopPropagation();
        ...
        // 橙色折叠块展开与折叠事件
        $(".cdepe div.cpexamps .cpexamps-head, .cdepe div#dataset-example .c_h, .cdepe div.link .di-head").off('click').on('click', function(e) {
            e.stopPropagation();
            if ($(this).parent().attr("expanded") !== undefined) {
        ...
        // 黄色折叠块展开与折叠事件
        $(".cdepe div.xref > h3.bb").off('click').on('click', function(e) {
            e.stopPropagation();
            if ($(this).parent().attr("expanded") !== undefined) {
                $(this).next().slideUp("fast");
                $(this).parent().removeAttr("expanded");
        ...
        // 浅蓝色折叠块展开与折叠事件
        $(".cdepe div.sense-body .phrase-head").off('click').on('click', function(e) {
            e.stopPropagation();
            if ($(this).parent().attr("expanded") !== undefined) {
                $(this).next().slideUp("fast");
                $(this).parent().removeAttr("expanded");
        ...
        // 浅米色折叠块展开与折叠事件
        $(".cdepe section > header.ca_h").off('click').on('click', function(e) {
            e.stopPropagation();
            if ($(this).parent().attr("expanded") !== undefined) {
                $(this).next().slideUp("fast");
                $(this).parent().removeAttr("expanded");
        ...
        // 一级释义折叠块展开与折叠事件
        $(".cdepe .pr.dsense .dsense_h").off('click').on('click', function(e) {
            e.stopPropagation();
            if ($(this).parent().attr("expanded") !== undefined) {
    ...
    function fnTouchToTranslate(itemValue) {
        ...
        // examples
        $(".cdepe .examp, .cdepe .dexamp").off('click').on('click', function(e) {
            e.stopPropagation();
       ...
       // 项义点击事件：显示和隐藏中文
        $(".cdepe div.def").off('click').on('click', function(event) {
       ...
       //  // Usage用法释义
       //  $(".cdepe span.ud_text").off('click').on('click', function(e) {
       //      e.stopPropagation();
       //      $(this).find(".mw_zh").fadeToggle("fast");
       //  });

       //  // 固定搭配释义
       //  $(".cdepe span.un_text").off('click').on('click', function(e) {
       //      e.stopPropagation();
       //      $(this).find(".mw_zh").fadeToggle("fast");
       //  }); 
    }
    ...
    function addNavigationSense() {
        ...
        $(".cdepe .entry-body .entry-body__el").each(function(e) {
            ...
            // 标题点击事件，展开/折叠
            containerTitle.off('click').on('click', function(e) {
    ...
    (async function initTTS() {
        ...
        cdepeCfg.enableOnlineTTS && $(".cdepe example-audio-ai a.audio_uk, .cdepe example-audio-ai a.audio_us").off('click').on('click', function(e) {
            e.stopPropagation();
            e.preventDefault();
